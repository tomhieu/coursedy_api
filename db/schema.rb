...
ActiveRecord::Schema.define(version: 20181229081505) do
  ...
  create_table "affiliate_agencies", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.string "address"
    t.string "phone"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_affiliate_agencies_on_user_id"
  end
  ...
  add_foreign_key "affiliate_agencies", "users"
